...
Il permet d'indiquer qu'un joueur identifié par son id a été retiré d'une équipe identifiée par son id.
...
- le joueur doit appartenir à l'équipe si cette règle est retenue
