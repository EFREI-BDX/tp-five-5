...
import com.group3.efreifive.recordmatch.service.ServiceOperationException;
...
class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RecordMatchServiceException.class)
    public ResponseEntity<Map<String, Object>> handleGenericError(RecordMatchServiceException exception) {
        GlobalExceptionHandler.log.error("Record match service error: {}", exception.getMessage());
